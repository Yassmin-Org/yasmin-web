...
import { GlobeAnimation } from "@/components/ui/globe-animation";
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center px-6 overflow-hidden">
      ...
      <div className="fixed bottom-6 right-6 z-20 flex flex-col gap-3">
        ...
        <a
          href="https://www.instagram.com/get_yasmin/"
          target="_blank"
          rel="noopener noreferrer"
          className="flex h-10 w-10 items-center justify-center rounded-full bg-white shadow-md transition-shadow hover:shadow-lg"
          title="Instagram"
        ...
        <a
          href="https://www.linkedin.com/company/yasminapp/?viewAsMember=true"
          target="_blank"
          rel="noopener noreferrer"
          className="flex h-10 w-10 items-center justify-center rounded-full bg-white shadow-md transition-shadow hover:shadow-lg"
          title="LinkedIn"
