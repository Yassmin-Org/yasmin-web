...
export default function CitizenshipPage() {
  ...
  const handleContinue = () => {
    localStorage.setItem("yasmin_reg_citizenship", JSON.stringify(selected));
    router.push("/register/legal-residence");
  };
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm text-gray-500">{t("citizenshipSubtitle")}</p>
      </div>
